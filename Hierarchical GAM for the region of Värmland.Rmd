...
```{r}
newdata<-data.frame(Sulphate=Series_V$Sulphate, SWEREFID="", datedecimal=Series_V$datedecimal)
...
```{r}
newdata2<-data.frame(Sulphate=Series_V$Sulphate, SWEREFID=Series_V$SWEREFID, datedecimal=Series_V$datedecimal)
